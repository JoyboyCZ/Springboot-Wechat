<template>
	<view class="content">
		<view :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#fff","height":"auto"}'>
			<view v-if="user&&user.id" :style='{"padding":"0 24rpx","margin":"0 0 20rpx 0","background":"none","display":"flex","width":"100%","position":"relative","height":"auto"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"alignContent":"center","alignItems":"center","flexWrap":"wrap","flex":"1","flexDirection":"column","display":"flex","height":"100%"}' v-if="tableName=='yonghu'" class="userinfo">
					...
					<view :style='{"width":"auto","flex":"1","flexDirection":"column","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"auto","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"center"}'>{{user.yonghuzhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					...
					<view :style='{"margin":"20rpx 0 0","flexDirection":"row","display":"flex","gap":"20rpx","width":"100%","flexFlow":"wrap","justifyContent":"center"}' class="info">
						<view :style='{"padding":"8rpx","borderRadius":"12rpx","textAlign":"center","background":"none","flexDirection":"column","display":"flex","width":"30%","lineHeight":"48rpx","fontSize":"28rpx"}'>
							<span :style='{"color":"#333"}'>手机号：</span>
							<span :style='{"color":"#333"}'>{{user.shoujihao}}</span>
						</view>
					</view>
				</view>
				<view :style='{"alignContent":"center","alignItems":"center","flexWrap":"wrap","flex":"1","flexDirection":"column","display":"flex","height":"100%"}' v-if="tableName=='jianshenzhuanjia'" class="userinfo">
					<image :style='{"width":"88rpx","padding":"0","margin":"0 20rpx 0 0","borderRadius":"100%","height":"88rpx"}' :src="user.touxiang?baseUrl+user.touxiang:require('../../static/gen/upload.png')"></image>
					<view :style='{"width":"auto","flex":"1","flexDirection":"column","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"auto","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"center"}'>{{user.zhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					
					<view :style='{"margin":"20rpx 0 0","flexDirection":"row","display":"flex","gap":"20rpx","width":"100%","flexFlow":"wrap","justifyContent":"center"}' class="info">
						<view :style='{"padding":"8rpx","borderRadius":"12rpx","textAlign":"center","background":"none","flexDirection":"column","display":"flex","width":"30%","lineHeight":"48rpx","fontSize":"28rpx"}'>
							<span :style='{"color":"#333"}'>联系方式：</span>
							<span :style='{"color":"#333"}'>{{user.lianxifangshi}}</span>
						</view>
					</view>
				</view>
				<view :style='{"alignContent":"center","alignItems":"center","flexWrap":"wrap","flex":"1","flexDirection":"column","display":"flex","height":"100%"}' v-if="tableName=='yingyangzhuanjia'" class="userinfo">
					<image :style='{"width":"88rpx","padding":"0","margin":"0 20rpx 0 0","borderRadius":"100%","height":"88rpx"}' :src="user.touxiang?baseUrl+user.touxiang:require('../../static/gen/upload.png')"></image>
					<view :style='{"width":"auto","flex":"1","flexDirection":"column","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"auto","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"center"}'>{{user.yingyangshizhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					
					<view :style='{"margin":"20rpx 0 0","flexDirection":"row","display":"flex","gap":"20rpx","width":"100%","flexFlow":"wrap","justifyContent":"center"}' class="info">
						<view :style='{"padding":"8rpx","borderRadius":"12rpx","textAlign":"center","background":"none","flexDirection":"column","display":"flex","width":"30%","lineHeight":"48rpx","fontSize":"28rpx"}'>
							<span :style='{"color":"#333"}'>联系电话：</span>
							<span :style='{"color":"#333"}'>{{user.lianxidianhua}}</span>
						</view>
					</view>
				</view>
				<view :style='{"padding":"0 0 0 20rpx","alignItems":"center","top":"20rpx","flexDirection":"row","display":"flex","width":"84rpx","position":"absolute","right":"40rpx","justifyContent":"center","height":"auto"}' class="setting">
					<text class="icon iconfont icon-qita6" :style='{"border":"0","margin":"0 10rpx 0 0","color":"#333","borderRadius":"0","width":"64rpx","lineHeight":"64rpx","fontSize":"64rpx"}'></text>
					<text :style='{"lineHeight":"2","fontSize":"28rpx","color":"#333","flex":"none"}'>设置</text>
				</view>
			</view>
			
			<view v-else :style='{"padding":"0 24rpx","margin":"0 0 20rpx 0","background":"none","display":"flex","width":"100%","position":"relative","height":"auto"}' @tap="loginClick" class="header" v-bind:class="{'status':isH5Plus}">
			...
			<view :style='{"width":"100%","background":"none","height":"auto"}' class="list">
				...
				<view :style='{"width":"100%","height":"auto"}'>
					<view :style='{"width":"100%","padding":"0 20rpx","background":"linear-gradient(135.00deg, rgb(130, 88, 207) 0%,rgb(84, 62, 129) 100%)","justifyContent":"space-between","display":"flex","height":"auto"}'>
					...
					<view class="me-menu-view">
						...
						<view v-if="changeHasChat()" @tap="getRecordList(1)" class="me-menu-item" hover-class="hover">
							<view class="cuIcon-news me-menu-icon"></view>
	...
	export default {
		...
		methods: {
			...
			async chatClick(row) {
				...
				uni.connectSocket({
					url: 'ws' + this.$base.url.split('http')[1] + '/ws?user_id=' + uni.getStorageSync("appUserid") + '&to_id=' + this.nowfid
				})
