	...
	mounted() {
		...
		this.$http({
			...
			if (data && data.code === 0) {
				...
				if(sessionTable == 'jianshenzhuanjia') {
					this.avatar = data.data.touxiang
				}
				if(sessionTable == 'yingyangzhuanjia') {
					this.avatar = data.data.touxiang
				}
...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item:hover {
		padding: 0 !important;
		color: #fff !important;
		background: url(http://codegen.caihongy.cn/20240918/88143850b2134c76b0313e6e52924b03.png) no-repeat center center / 100% 100% !important;
		width: 100% !important;
		line-height: 32px !important;
		height: 32px !important;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
		padding: 0;
		color: #fff;
		background: url(http://codegen.caihongy.cn/20240918/88143850b2134c76b0313e6e52924b03.png) no-repeat center center / 100% 100%;
		width: 100%;
		line-height: 32px;
		height: 32px;
	}
