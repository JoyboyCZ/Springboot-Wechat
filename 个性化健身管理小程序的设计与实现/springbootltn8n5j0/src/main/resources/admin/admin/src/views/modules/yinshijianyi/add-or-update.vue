	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="建议类型" prop="jianyileixing" >
					<el-select :disabled="ro.jianyileixing" v-model="ruleForm.jianyileixing" placeholder="请选择建议类型" >
						<el-option
							v-for="(item,index) in jianyileixingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="建议类型" prop="jianyileixing" >
					<el-input v-model="ruleForm.jianyileixing"
						placeholder="建议类型" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.neirong" label="内容" prop="neirong" >
				<span class="text">{{ruleForm.neirong}}</span>
			</el-form-item>
