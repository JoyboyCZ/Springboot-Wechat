<template>
	<div class="main-content" :style='{"width":"100%","padding":"20px 30px","fontSize":"15px","background":"#ffffff"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"border":"0px solid #fff","margin":"0 0px 0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","order":"2"}' >
					...
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">早餐摄入</label>
						<el-input v-model="searchForm.zaocansherustart" placeholder="最小早餐摄入" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}' :label="'至'">
						<el-input v-model="searchForm.zaocansheruend" placeholder="最大早餐摄入" clearable></el-input>
					</div>
				...
				<el-row class="actions" :style='{"padding":"10px","margin":"0px 0","flexWrap":"wrap","background":"none","display":"flex"}'>
					...
					<el-button class="btn18" v-if="isAuth('yinshijilu','早餐总摄入量')" type="success" @click="chartDialog1()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						早餐总摄入量
					</el-button>
					<el-button class="btn18" v-if="isAuth('yinshijilu','午餐总摄入量')" type="success" @click="chartDialog2()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						午餐总摄入量
					</el-button>
					<el-button class="btn18" v-if="isAuth('yinshijilu','晚餐总摄入量')" type="success" @click="chartDialog3()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						晚餐总摄入量
					</el-button>
					<el-button class="btn18" v-if="isAuth('yinshijilu','加餐总摄入量')" type="success" @click="chartDialog4()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						加餐总摄入量
					</el-button>
					<el-button class="btn18" v-if="isAuth('yinshijilu','总摄入热量')" type="success" @click="chartDialog5()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"34px"}'></span>
						总摄入热量
					</el-button>
				</el-row>
			...
			<div :style='{"border":"0px solid #fff","padding":"0","color":"#000","background":"none","borderWidth":"0","width":"100%","fontSize":"14px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true'  
						...
						label="加餐摄入">
						<template slot-scope="scope">
							{{scope.row.jiacansheru}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="sheruzongreliang"
						label="摄入总热量">
						<template slot-scope="scope">
							{{scope.row.sheruzongreliang}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="dengjishijian"
		...
		<el-dialog
			...
			width="800">
			<div id="zaocansheruChart1" style="width:100%;height:600px;"></div>
		...
		<el-dialog
			...
			width="800">
			<div id="zhongcansheruChart2" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="wancansheruChart3" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="jiacansheruChart4" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="sheruzongreliangChart5" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
	...
	export default {
		...
		methods: {
			...
			chartDialog1() {
				...
				this.$nextTick(()=>{
					var zaocansheruChart1 = echarts.init(document.getElementById("zaocansheruChart1"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							zaocansheruChart1.setOption(option);
							  //根据窗口的大小变动图表
							window.onresize = function() {
								zaocansheruChart1.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog2() {
				...
				this.$nextTick(()=>{
					...
					var zhongcansheruChart2 = echarts.init(document.getElementById("zhongcansheruChart2"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							zhongcansheruChart2.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								zhongcansheruChart2.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog3() {
				...
				this.$nextTick(()=>{
					...
					var wancansheruChart3 = echarts.init(document.getElementById("wancansheruChart3"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							wancansheruChart3.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								wancansheruChart3.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog4() {
				...
				this.$nextTick(()=>{
					...
					var jiacansheruChart4 = echarts.init(document.getElementById("jiacansheruChart4"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							jiacansheruChart4.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								jiacansheruChart4.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog5() {
				...
				this.$nextTick(()=>{
					...
					var sheruzongreliangChart5 = echarts.init(document.getElementById("sheruzongreliangChart5"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							sheruzongreliangChart5.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								sheruzongreliangChart5.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			getDataList() {
				...
				let params = {
 				...
 				if(this.searchForm.zaocansherustart!='' && this.searchForm.zaocansherustart!=undefined ){
					params['zaocansherustart'] = this.searchForm.zaocansherustart
				}
				if(this.searchForm.zaocansheruend!='' && this.searchForm.zaocansheruend!=undefined){
					params['zaocansheruend'] = this.searchForm.zaocansheruend
				}
